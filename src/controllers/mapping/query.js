...
const { USER_HIERARCHY, SCHEMA, OBJECTKEYNAME, RECORD_TYPES, RECORDS_PER_PAGE } = require("../../utilities/constants");



const distributorMapping = {
    // all distributors
    getDistributorMapping: async(userSfid, pageNumber, territory2Status, profile, searchField) => {
        try {
            let qry = `
                SELECT
