  ...
  getAllFarmersByTerritory: async (
    ...
    try {
      ...
      qry += `
            ...
            AND
            ${SCHEMA.SALESFORCE.ACCOUNT}.${OBJECTKEYNAME.RECORD_TYPE} = '${RECORD_TYPES.FARMER}'
            AND
            ${SCHEMA.SALESFORCE.ACCOUNT}.${OBJECTKEYNAME.IS_PARTIAL_FARMER__c} = '${false}'
            AND
...
`;
  ...
  // get all the crops related to the specific farmer
